...
for i in range(len(ciphertexts)):
	ciphertexts[i] = ciphertexts[i].decode('base64').encode('hex')

plaintext1 = "message 86831. Test message 86831. Test message 86831. Test message 86831. Test message 86831. Test message 86831. Test message 86831. Test message 86831. Test message 86831. Test message 86831."

# we got p4 and p1 but didn't know which was which
# key = p1 ^ c1, or p4 ^ c4. Just try both combos.
# once we have key xor it with any other ciphertext to decrypt